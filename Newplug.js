...
(function() {
    if (!requirejs.defined('b6946/cc764/c32ac'))
        return API.chatLog('This version of plug&#179; is not compatible with this version of plug.dj', true), false;

    define('ff0831/c960fa', ['jquery', 'underscore', 'b6946/cc764/c32ac', 'b6946/cc764/db6d5', 'b6946/a5bb2/dc040', 'b6946/a7d73/f3e47', 'b6946/c5f61/b3aeb', 'b6946/dd345/e7294', 'b6946/f9f3f/fe079', 'b6946/c7364/c68b0', 'b6946/c7364/f308e', 'b6946/dd345/d33f1', 'lang/Lang', 'b6946/c8edc/a9ccc/e0f25', 'b6946/f9f3f/bd4e9', 'b6946/f9f3f/fdad8', 'ff0831/e4a458', 'b6946/c8edc/a9ccc/ae0ee/ef7a2', 'b6946/c8edc/a9ccc/ae0ee/c3ca3', 'ff0831/b978ba', 'ff0831/ecb90b', 'ff0831/ac3e26', 'b6946/a7d73/ff4bc', 'b6946/dd345/c99cd', 'ff0831/cd4ccc/c52d43', 'ff0831/b8f89a', 'ff0831/ed26d7', 'ff0831/cd4ccc/e7144c', 'b6946/c8edc/a9ccc/f5f73/c8883', 'b6946/c8edc/a9ccc/ae0ee/cf97f'], function($, _, Class, Context, Chat, LocalStorage, Utils, Room, MCE, Socket, SIO, TUM, Lang, Audience, RJE, RSE, Styles, RoomUserListView, RoomUserListRow, _RoomUserListRow, p3Lang, p3Utils, Database, PlaybackModel, dialogCommands, Slider, VolumeView, dialogColors, PopoutView, UserPanelView) {
        ...
        return Class.extend({
            ...
            onRoomJoin: function() {
                if (typeof plugCubed !== 'undefined') {
                    setTimeout(function() {
                        if (API.enabled) $.getScript('https://d1rfegul30378.cloudfront.net/files/plugCubed.' + (version.minified ? 'min.' : '') + 'js');
            ...
            close: function() {
                ...
                requirejs.undef('ff0831/c960fa');
                requirejs.undef('ff0831/cd4ccc/bd6db0');
                requirejs.undef('ff0831/cd4ccc/b8421b');
                requirejs.undef('ff0831/cd4ccc/e7144c');
                requirejs.undef('ff0831/cd4ccc/c52d43');
                requirejs.undef('ff0831/ecb90b');
                requirejs.undef('ff0831/afe9e4');
                requirejs.undef('ff0831/ac3e26');
                requirejs.undef('ff0831/b8f89a');
                requirejs.undef('ff0831/f0a227');
                requirejs.undef('ff0831/b978ba');
                requirejs.undef('ff0831/ed26d7');
                Styles.destroy();
                requirejs.undef('ff0831/e4a458');
                this.loaded = false;
                delete plugCubed;
            },
            /**
                ...
                socket.onmessage = function(msg) {
                    ...
                    if (type === 'update') {
                        ...
                        return setTimeout(function() {
                            $.getScript('https://d1rfegul30378.cloudfront.net/files/plugCubed.' + (version.minified ? 'min.' : '') + 'js');
                        }, 5000);
                    }
                    if (type === 'chat') {
    ...
    define('ff0831/cd4ccc/bd6db0', ['underscore', 'b6946/a7d73/f3e47', 'ff0831/ecb90b', 'b6946/f9f3f/e2663', 'b6946/f9f3f/b1b73', 'b6946/a5bb2/dc040', 'b6946/dd345/d33f1', 'b6946/dd345/bb577', 'b6946/fb7df/ae0ee/c7c65', 'b6946/c5f61/b3aeb', 'b6946/c8edc/aa8f6/d1a8e', 'b6946/c8edc/ddf8d/a141a', 'lang/Lang'], function(_, LocalStorage, p3Lang, t, n, r, i, s, o, u, a, f, l) {
        var langauges,
            c = a.extend({
    ...
    define('ff0831/cd4ccc/e7144c', ['jquery', 'b6946/cc764/c32ac', 'lang/Lang', 'b6946/cc764/db6d5', 'ff0831/ecb90b'], function($, b, c, d, p3Lang) {
    ...
    define('ff0831/cd4ccc/f16435', ['jquery', 'b6946/c8edc/aa8f6/d1a8e', 'lang/Lang', 'b6946/cc764/c32ac', 'b6946/cc764/db6d5', 'b6946/f9f3f/a892f', 'ff0831/ecb90b'], function($, b, c, d, e, f, p3Lang) {
        var a = d.extend({
            init: function(id) {
    ...
    define('ff0831/cd4ccc/c52d43', ['jquery', 'b6946/cc764/c32ac', 'lang/Lang', 'ff0831/ecb90b', 'ff0831/ac3e26'], function($, b, c, p3Lang, p3Utils) {
        var userCommands = [
    ...
    define('ff0831/e4a458', ['jquery', 'b6946/cc764/c32ac'], function($, Class) {
        var obj,
            styles = {},
            update = function() {
                var a = '';
    ...
    define('ff0831/ac3e26', ['b6946/cc764/c32ac', 'b6946/c8edc/a9ccc/f5f73/c8883', 'ff0831/ecb90b'], function(Class, PopoutView, p3Lang) {
    ...
    define('ff0831/b978ba', ['jquery', 'b6946/c8edc/a9ccc/ae0ee/f8c0c', 'ff0831/ecb90b', 'ff0831/ac3e26', 'b6946/cc764/db6d5'], function($, RoomUserListRow, p3Lang, p3Utils, Context) {
    ...
    define('ff0831/ecb90b', ['jquery', 'b6946/cc764/c32ac'], function($, Class) {
        var language = {},
            isLoaded = false,
            Lang = Class.extend({
                init: function() {
    ...
    define('ff0831/b8f89a', ['jquery', 'b6946/cc764/c32ac'], function($, Class) {
        return Class.extend({
    ...
    define('ff0831/f0a227', ['jquery', 'b6946/cc764/c32ac', 'ff0831/c960fa', 'b6946/a7d73/f3e47', 'b6946/c8edc/aa8f6/d1a8e', 'ff0831/ecb90b', 'ff0831/ac3e26'], function($, Class, Model, LocalStorage, ADV, p3Lang, p3Utils) {
    ...
    */
    define('ff0831/ed26d7', ['jquery', 'underscore', 'b6946/c8edc/a9ccc/ce27c/b2852', 'b6946/dd345/c99cd', 'hbs!template/room/playback/Volume', 'b6946/cc764/db6d5', 'ff0831/ecb90b'], function($, e, original, r, s, Context, p3Lang) {
    ...
    require(['ff0831/c960fa', 'ff0831/ac3e26'], function(a, b) {
        plugCubed = new a();
    });
})();
